...
elseif (isSet($sent) && $sent && $page=="donating")
{
...
<?php include "bannerandmenu.php"?>
	...
	<div class="bothsides">
		...
		<hr>
		<p><?php
		// this file seems to have disappeared in a past change
		// include "financenews.php"
		 ?>
		 </p>
		</div>
		<div class="rightside">
...
<div class="formline">
	...
	<input type="text" name="first_name" value="<?php echo isSet($first_name) ? $first_name : ''; ?>" size="20" maxlength="100">
</div>
<div class="formline">
	<div class="label">Last Name:</div>
	<input type="text" name="last_name" value="<?php echo isSet($last_name) ? $last_name : ''; ?>" size="20" maxlength="100">
</div>
<div class="formline">
	<div class="label">Address:</div>
	<input type="text" name="address1" value="<?php echo isSet($address1) ? $address1 : ''; ?>" size="20" maxlength="100">
</div>
<div class="formline">
	<div class="label">Address cont.:</div>
	<input type="text" name="address2" value="<?php echo isSet($address2) ? $address2 : ''; ?>" size="20" maxlength="100">
</div>
<div class="formline">
	<div class="label">City:</div>
	<input type="text" name="city" size="20" value="<?php echo isSet($city) ? $city : ''; ?>" maxlength="100">
</div>
<div class="formline">
	<div class="label">State:</div>
	<input type="text" name="state" size="20" value="<?php echo isSet($state) ? $state : ''; ?>" maxlength="100">
</div>
<div class="formline">
	<div class="label">Zipcode:</div>
	<input type="text" name="zip" size="10" value="<?php echo isSet($zip) ? $zip : ''; ?>" maxlength="100">
</div>
<div class="formline">
	<div class="label" >Phone:</div>
	<input type="text" name="night_phone_a" value="<?php echo isSet($night_phone_a) ? $night_phone_a : ''; ?>" size="20" maxlength="100">
</div>
<div class="formline">
	<div class="label<?php echo isError('email')?>">Email<span class="importantstar">*</span>:</div>
	<input type="text" name="email" value="<?php echo isSet($email) ? $email : ''; ?>" size="20" maxlength="100">
</div>
<div class="formline">
	<div class="label">Box #:</div>
	<input type="text" name="custom" value="<?php echo isSet($custom) ? $custom : ''; ?>" size="10" maxlength="100">
</div>
...
?>
<input type="hidden" name="item_name_1" value="Tithes">
<div class="formline"><div class="label<?php echo isError('amount_1') ?>">
Tithes: </div> <input type="text" name="amount_1" value="<?php $amount_1 ?>" size="10" maxlength="100"> USD</div>

<input type="hidden" name="item_name_2" value="General">
<div class="formline"><div class="label<?php echo isError('amount_2') ?>">
General Offering:</div><input type="text" name="amount_2" value="<?php $amount_2 ?>" size="10" maxlength="100"> USD</div>

<input type="hidden" name="item_name_3" value="Benevolence">
<div class="formline"><div class="label<?php echo isError('amount_3') ?>">
Benevolence:</div> <input type="text" name="amount_3" value="<?php $amount_3 ?>" size="10" maxlength="100"> USD</div>

<input type="hidden" name="item_name_4" value="Building">
<div class="formline"><div class="label<?php echo isError('amount_4') ?>">
Building Fund:</div> <input type="text" name="amount_4" value="<?php $amount_4 ?>" size="10" maxlength="100"> USD</div>

<input type="hidden" name="item_name_5" value="Missions">
<div class="formline"><div class="label<?php echo isError('amount_5') ?>">
Mission s:</div> <input type="text" name="amount_5" value="<?php $amount_5 ?>" size="10" maxlength="100"> USD</div>

<input type="hidden" name="item_name_6" value="Pledge">
<div class="formline"><div class="label<?php echo isError('amount_6') ?>">
Pledge Offering:</div> <input type="text" name="amount_6" value="<?php $amount_6 ?>" size="10" maxlength="100"> USD</div>
...
?>
	<div class="formline">
		<div class="label<?php echo isError('amount')?>">Amount<span class="importantstar">*</span>:</div>
		<input type="text" name="amount" value="<?php echo isSet($amount) ? $amount : '' ?>" size="20" maxlength="100">USD
	</div>
	<div id="donatingto" class="formline">
		<div class="label">Donating To:</div>
