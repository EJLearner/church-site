...
switch ($page)
{
	...
	case("wwomack");
		...
		$name="Woodrow Womack";
		$serviceSiteWebsite = "https://vaughncgreene.com/82/Randallstown.html";
		$serviceSiteName = "Vaughn Greene Randallstown";
		$serviceSiteAddress = "8728 Liberty Road, Randallstown, Maryland 21133";
		$serviceDate = "Friday, February 8";
		$serviceTimeAndInfo =
			"Wake: 10:00 a.m. - 10:30 a.m.<br>
			Funeral: 10:30 a.m.</p>";
